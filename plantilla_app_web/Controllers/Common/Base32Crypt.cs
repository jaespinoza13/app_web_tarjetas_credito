/*
* jacarrio1 - 31/Mar/2023
* Esta clase permite codificar y decodificar a Base32
* Para usarlo se debe hacer de la siguiente forma:
* 
* string base32Secret = "1sdfsdf0sdfsdfs9zxc=";
* byte [] byt32 = Encoding.ASCII.GetBytes(base32Secret);
* string b32 = Base32Crypt.Encode(byt32);
*/
...
namespace plantilla_app_web.Controllers.Common {
    public static class Base32Crypt {
        ...
        public static string EncodeString( string data, bool padOutput = false ) {
            byte [] byt32 = Encoding.ASCII.GetBytes(data);
            return Encode(byt32, padOutput);
        }
